...
module InformationMachineApi
  class UserScansController
    ...
    # @param [String] user_id Required parameter: TODO: type description here
    # @param [String] receipt_id Required parameter: TODO: type description here
    # @return UploadReceiptStatusWrapper response from the API call
    def user_scans_get_receipt_status user_id, receipt_id
      # the base uri for api requests
      query_builder = Configuration.BASE_URI.dup
