...
module InformationMachineApi
  class UserPurchasesController
    ...
    def user_purchases_get_all_user_loyalty_purchases user_id, store_id: nil, page: nil, per_page: nil, food_only: nil, upc_only: nil, upc_resolved_after: nil
      # the base uri for api requests
      query_builder = Configuration::BASE_URI.dup
